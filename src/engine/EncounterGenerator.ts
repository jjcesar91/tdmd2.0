...
export const generateEncounter = (enemyType: string): (Unit | null)[] => {
    ...
    if (enemyType === 'frogs_tribe_1') {
      ...
      enemies[2] = { name: 'Void Mage', id: 'guard2', desc: '', hp: 4, maxHp: 4, dead: false, buffs: { immune: false, tanking: false, augment: 0 } };
    } else {
      ...
      switch(encounterType) {
        case 0: // "THE PRESSURE" - Swarm with surprise burst
          ...
          enemies[0] = { name: 'Skeleton', id: 'fake1', desc: '', hp: 2, maxHp: 2, dead: false, buffs: { immune: false, tanking: false, augment: 0 } };
          enemies[1] = { name: 'Dark Assassin', id: 'assassin', desc: '', hp: 4, maxHp: 4, dead: false, buffs: { immune: false, tanking: false, augment: 0 } };
          enemies[2] = { name: 'Skeleton', id: 'fake2', desc: '', hp: 2, maxHp: 2, dead: false, buffs: { immune: false, tanking: false, augment: 0 } };
          break;
        ...
        case 1: // "THE WALL" - Tank + Support behind
          ...
          enemies[0] = { name: 'Armored Knight', id: 'tank', desc: '', hp: 6, maxHp: 6, dead: false, buffs: { immune: false, tanking: false, augment: 0 } };
          enemies[2] = { name: 'Blood Cultist', id: 'buffer', desc: '', hp: 4, maxHp: 4, dead: false, buffs: { immune: false, tanking: false, augment: 0 } };
          break;
        ...
        case 2: // "THE FLANKERS" - Speed vs Defense choice
          ...
          enemies[0] = { name: 'Shadow Wraith', id: 'wraith1', desc: '', hp: 3, maxHp: 3, dead: false, buffs: { immune: false, tanking: false, augment: 0 } };
          enemies[2] = { name: 'Shadow Wraith', id: 'wraith2', desc: '', hp: 3, maxHp: 3, dead: false, buffs: { immune: false, tanking: false, augment: 0 } };
          break;
        ...
        case 3: // "THE SHIELD WALL" - Defense spam test
          ...
          enemies[1] = { name: 'Void Mage', id: 'mage', desc: '', hp: 3, maxHp: 3, dead: false, buffs: { immune: false, tanking: false, augment: 0 } };
          enemies[0] = { name: 'Armored Knight', id: 'knight', desc: '', hp: 6, maxHp: 6, dead: false, buffs: { immune: false, tanking: false, augment: 0 } };
          break;
        ...
        case 4: // "THE NECROMANCER" - Value race
          ...
          enemies[1] = { name: 'Necromancer', id: 'necro', desc: '', hp: 4, maxHp: 4, dead: false, buffs: { immune: false, tanking: false, augment: 0 } };
          enemies[0] = { name: 'Skeleton', id: 'minion1', desc: '', hp: 2, maxHp: 2, dead: false, buffs: { immune: false, tanking: false, augment: 0 } };
          enemies[2] = { name: 'Skeleton', id: 'minion2', desc: '', hp: 2, maxHp: 2, dead: false, buffs: { immune: false, tanking: false, augment: 0 } };
          break;
        ...
        case 5: // "THE EXECUTIONER" - Single massive threat
          ...
          enemies[1] = { name: 'Berserker', id: 'zerk', desc: '', hp: 5, maxHp: 5, dead: false, buffs: { immune: false, tanking: false, augment: 0 } };
          break;
        ...
        case 6: // "THE PLAGUE" - Multi-hit nightmare
          ...
          enemies[1] = { name: 'Plague Doctor', id: 'plague', desc: '', hp: 3, maxHp: 3, dead: false, buffs: { immune: false, tanking: false, augment: 0 } };
          enemies[0] = { name: 'Skeleton', id: 'carrier1', desc: '', hp: 2, maxHp: 2, dead: false, buffs: { immune: false, tanking: false, augment: 0 } };
          enemies[2] = { name: 'Skeleton', id: 'carrier2', desc: '', hp: 2, maxHp: 2, dead: false, buffs: { immune: false, tanking: false, augment: 0 } };
          break;
        ...
        case 7: // "THE CULT" - Synergy hell
          ...
          enemies[0] = { name: 'Orc Warrior', id: 'warrior', desc: '', hp: 5, maxHp: 5, dead: false, buffs: { immune: false, tanking: false, augment: 0 } };
          enemies[1] = { name: 'Blood Cultist', id: 'cultist', desc: '', hp: 4, maxHp: 4, dead: false, buffs: { immune: false, tanking: false, augment: 0 } };
          enemies[2] = { name: 'Goblin Shaman', id: 'shaman', desc: '', hp: 3, maxHp: 3, dead: false, buffs: { immune: false, tanking: false, augment: 0 } };
          break;
      }
    }
    return enemies;
